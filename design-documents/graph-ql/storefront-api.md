...
Proposed API do not satisfy "greedy" principe. It always will return **totalCount** in response.
Mixing different fields in request using dot notation can help to solve this issue.

We just need to follow simple rule: *"all requested fields are returned in corresponding containers"*
